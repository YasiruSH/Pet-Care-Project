<?php
    ...
    if(isset($_POST['getDates'])){
        ...
        if($type == "specialized"){
            $query = mysqli_query($con, "INSERT INTO bookingsp(category, age, date, time, serviceType, user) VALUES('".$category."', ".$age.", '".$date."', '".$time."', 'E', '".$id."')");
            echo "success";
        }
        ...
        $query = mysqli_query($con, "SELECT * FROM bookingsp WHERE date='".$date."' ");
