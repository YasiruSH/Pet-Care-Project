<?php
    ...
    if(isset($_POST['getDates'])){
        ...
        if($type == "vaccination"){
            $query = mysqli_query($con, "INSERT INTO booking(category, age, date, time, serviceType, user) VALUES('".$category."', ".$age.", '".$date."', '".$time."', 'A', '".$id."')");
            echo "success";
        }
        ...
        $query = mysqli_query($con, "SELECT * FROM booking WHERE date='".$date."' ");
