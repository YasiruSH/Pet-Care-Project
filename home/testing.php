...
<!-- Mirrored from themebeyond.com/pre/petco-prev/petco-live/adoption.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Apr 2023 08:32:07 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
                                ...
                                <nav class="menu-nav show">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="active menu-item-has-children"><a href="services.php">Services</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Testing & Diagnosisg Booking</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="comment-reply-box">
                                <h5 class="title">Testing & Diagnosisg Booking</h5>
                                ...
                                <div class="widget breeder-widget">
                                    ...
                                    <form action="#" class="sidebar-find-pets">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-grp">
                                                    ...
                                                    <input type="text" placeholder="Pet Category" id="category">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                            <div class="form-grp">
                                                    
                                                    <input type="text" placeholder="Pet Age" id="age">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-grp">
                                            ...
                                            <div class="col-6">
                                                <div class="form-grp" id="timeSelector">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button class="btn" id="booking">Submit Booking</button>
                                    </form>
                                </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog.php"><img src="/../Pet/img/blog/blog_post_thumb03.jpg" alt=""></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog-details.html"><img src="/../Pet/img/blog/rc_post_thumb02.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
        ...
        <script>
            $(document).ready(function () {
                $.ajax({
                    type: "post",
                    url: "database/ajaxtesting.php",
                    data: {
                        getDates : "yes",
                    },
                    dataType: "text",
                    success: function (response) {
                        $('#timeSelector').html(response);
                    }
                });
            });
...
<!-- Mirrored from themebeyond.com/pre/petco-prev/petco-live/adoption.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Apr 2023 08:32:12 GMT -->
</html>
